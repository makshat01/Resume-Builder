...
<body>
    ...
    <div id="background">
        ...
        <div id="loginContainer">
            ...
            <div id="loginText">
                <h1>Get great Resume, right now</h1>
                <ul>
                    <li>Discover skills you will fall in love with.</li>
                    <li>Create your own resume.</li>
                    <li>Follow your dreams and keep up with them.</li>
                </ul>
            </div>
